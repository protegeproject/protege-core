    ...
    public static URI ensureExtension(URI uri, String string) {
        ...
        if (uri.toString().endsWith(string)) {
            ...
            try {
                ...
                Log.exception(e, URIUtilities.class, "ensureExtension", uri, string);
            }
        }
        return goodURI;
    }
        ...
        if (uri != null) {
            try {
                ...
                try {
                    ...
                    Log.exception(urlException, URIUtilities.class, "createReader", uri);
                } catch (IOException ioException) {
                    Log.exception(ioException, URIUtilities.class, "createReader", uri);
                }
            }
        }
        return reader;
