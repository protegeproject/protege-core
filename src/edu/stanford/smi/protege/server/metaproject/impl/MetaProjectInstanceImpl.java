...
public class MetaProjectInstanceImpl extends WrappedProtegeInstanceImpl implements MetaProjectInstance, Serializable {
  ...
  protected MetaProjectInstanceImpl(MetaProjectImpl mp, Instance pi) {
    ...
    operations = (Set<GroupAndOperation>) getSlotValues(SlotEnum.allowedGroupOperation, ClsEnum.GroupOperation);
  }
