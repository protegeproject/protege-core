...
public class Server extends UnicastRemoteObject implements RemoteServer {
    ...
    /**
     * Calls startServer with {@link ServerRmiSocketFactory}as the socket
     * factory.
     */
     ...
     */
    public static void startServer(String[] args, RMISocketFactory sf)
            throws IOException {
    ...
    private Registry getRegistry() throws RemoteException {
        int port = Integer.getInteger("protege.rmi.registry.port",
    ...
    protected void bindName() throws RemoteException {
        try {
            ...
            _baseURI = new URI("rmi:" + "//" + getMachineName() + "/"
                    + boundName);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public RemoteSession openSession(String username, String userMachine,
            String password) {
    ...
    private void recordDisconnection(RemoteSession session,
            RemoteServerProject project) {
    ...
    private ServerProject createServerProject(String name, Project p) {
        ...
        try {
            ...
            Log.exception(e, this, "createServerProject", name, p);
        }
        return impl;
    }
    ...
    private Project createProject(String name) {
        ...
        while (i.hasNext()) {
            ...
            if (projectName.equals(name)) {
                String projectLocation = (String) instance
                        .getOwnSlotValue(_locationSlot);
                projectLocation = localizeLocation(projectLocation);
                URI uri = URIUtilities.createURI(projectLocation);
                project = Project
                        .loadProjectFromURI(uri, new ArrayList(), true);
    ...
    public Collection getAvailableProjectNames(RemoteSession session) {
        ...
        while (i.hasNext()) {
            ...
            if (file.exists() && file.isFile()) {
                ...
                Log.warning("Missing project at " + fileName, this,
    ...
    private boolean isValid(String name, String password) {
        ...
        while (i.hasNext()) {
            ...
            if (username.equals(name)) {
                String userpassword = (String) user
                        .getOwnSlotValue(_passwordSlot);
    ...
    private void save(ServerProject serverProject, Project project) {
        try {
	        Log.trace("saving " + project, this, "save");
	        Collection errors = new ArrayList();
            ...
            // can't happen
            Log.exception(e, this, "save", serverProject, project);
        }
    }

    private void dumpErrors(Project p, Collection errors) {
        if (!errors.isEmpty()) {
            Log.error("Unable to save project " + p, this, "dumpErrors");
