...
public class ClientRmiSocketFactory extends RMISocketFactory {
    ...
    public ClientRmiSocketFactory() {
        ...
        if (!isDefault()) {
            Log.trace("server=" + serverPort + ", serverLocal= "
                    + serverLocalPort + ", registryPort=" + registryPort
                    + ", registryLocal=" + registryLocalPort, this,
    ...
    public Socket createSocket(String host, int port) throws IOException {
        ...
        if (!isDefault()) {
            Log.trace("localPort=" + socket.getLocalPort(), this,
                    "createSocket", host, new Integer(port));
        }
        return socket;
    }
