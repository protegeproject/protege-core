...
public abstract class AbstractFrameStoreInvocationHandler implements InvocationHandler {
    ...
    public static Object getInstance(Class clas, KnowledgeBase kb)
    ...
    public static FrameStore newInstance(Class handlerClass, KnowledgeBase kb) {
        FrameStore fs = null;
        try {
            AbstractFrameStoreInvocationHandler handler =
                (AbstractFrameStoreInvocationHandler) getInstance(handlerClass, kb);
            fs =
            ...
            Log.exception(e, AbstractFrameStoreInvocationHandler.class, "newInstance", handlerClass, kb);
        }
        return fs;
    }
