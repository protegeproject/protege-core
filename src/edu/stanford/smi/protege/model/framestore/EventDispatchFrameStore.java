...
public class EventDispatchFrameStore extends ModificationFrameStore {
    ...
    private static final int DELAY_MSEC = 1 * 1000 * 10;
    ...
    // We need to ignore exceptions in the server client because we get a lot of
    // them because of event processing
    // problems
    private void dispatchEvents(Collection events, boolean ignoreExceptions) {
        ...
        while (i.hasNext()) {
            ...
            try {
                ...
                if (!ignoreExceptions) {
                    Log.exception(e, this, "dispatchEvents");
                }
            }
        }
    }
    ...
    private void dispatchKbEvent(KnowledgeBaseEvent event) {
        ...
        while (i.hasNext()) {
            ...
            case KnowledgeBaseEvent.DEFAULT_FACET_METACLASS_CHANGED:
                ...
                break;
            default:
                Log.trace("bad event", this, "dispatchKbEvent", event);
                break;
            }
        }
    }
    ...
    private void dispatchClsEvent(ClsEvent event) {
        ...
        while (i.hasNext()) {
            ...
            case ClsEvent.TEMPLATE_FACET_VALUE_CHANGED:
                ...
                break;
            default:
                Log.error("bad event", this, "dispatchClsEvent", event);
                break;
            }
        }
    }
    ...
    private void dispatchFrameEvent(FrameEvent event) {
        ...
        while (i.hasNext()) {
            ...
            case FrameEvent.DELETED:
            	...
            	break;
            default:
                Log.error("bad event", this, "dispatchFrameEvent", event);
            }
        }
    }
