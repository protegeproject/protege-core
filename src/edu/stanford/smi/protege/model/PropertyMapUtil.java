...
public class PropertyMapUtil {
    ...
    private static Object getFrame(String value) {
        ...
        if (frame == null) {
            Log.warning("unable to load frame", PropertyMapUtil.class, "getFrame", value);
        }
        return frame;
    }
    ...
    private static Object getJavaClass(String className) {
        ...
        if (clas == null) {
            Log.warning("unable to load class", PropertyMapUtil.class, "getJavaClass", className);
        }
        return clas;
    }
    ...
    private static Object getJavaClassObject(String className, String value) {
        ...
        if (c == null) {
            Log.warning("Unable to load class", PropertyMapUtil.class, "getJavaClassObject", className, value);
        } else {
            try {
                Constructor constructor = c.getConstructor(new Class[] { String.class });
                if (constructor == null) {
                    String text = "Class has no string constructor";
                    Log.warning(text, PropertyMapUtil.class, "getJavaClassObject", className, value);
                } else {
                    result = constructor.newInstance(new Object[] { value });
                }
            } catch (Exception e) {
                Log.exception(e, PropertyMapUtil.class, "getJavaClassObject", className, value);
            }
        }
        return result;
    }
    ...
    private static Object getMap(String value) {
        ...
        if (map == null) {
            ...
            if (mapInstance == null) {
                Log.error("missing map instance", PropertyMapUtil.class, "getMap", value);
            } else {
    ...
    private static Object getRectangle(String value) {
        ...
        try {
            ...
            Log.exception(e, PropertyMapUtil.class, "getRectangle", value);
            result = null;
        }
        return result;
    }
    ...
    private static void storeMap(Map map, Instance mapInstance) {
        ...
        while (i.hasNext()) {
            ...
            if (key == null || value == null) {
                Log.warning("Unable to store null", PropertyMapUtil.class, "storeMap", key, value);
            } else {
