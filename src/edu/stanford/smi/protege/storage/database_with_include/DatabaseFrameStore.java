...
public class DatabaseFrameStore extends SimpleFrameStore {
    ...
    public DatabaseFrameStore(
        ...
        super(
            kb,
            getBasicFrameStore(
                new DatabaseFrameDb(getFrameFactory(kb), helper, driver, url, username, password, tablename)));
    ...
    private static NarrowFrameStore getBasicFrameStore(DatabaseFrameDb db) {
