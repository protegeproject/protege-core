 ...
 */
public class DirectInstancesList extends SelectableContainer implements
        Disposable {
    ...
    protected Action createSetDisplaySlotMultipleAction() {
        return new AbstractAction("Multple Slots...") {
            public void actionPerformed(ActionEvent event) {
                ...
                int rval = ModalDialog.showDialog(DirectInstancesList.this, panel, "Multislot Display Pattern", ModalDialog.MODE_OK_CANCEL);
