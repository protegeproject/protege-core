...
public class RobustConnection {
    ...
    private void initializeSupportsBatch() throws SQLException {
        ...
        if (!_supportsBatch) {
            ...
            Log.warning(s, this, "initializeSupportsBatch");
        }
    }
    ...
    private void initializeSupportsTransactions() throws SQLException {
        ...
        if (!_supportsTransactions) {
            Log.warning("This database does not support transactions", this, "initializeSupportsTransactions");
        }
    }
    ...
    */
    ...
    public boolean beginTransaction() {
        ...
        try {
            ...
            Log.warning("Cannot begin transaction", this, "beginTransaction");
        }
        return begun;
    }
    ...
    public boolean commitTransaction() {
        ...
        try {
            ...
            Log.exception(e, this, "commitTransaction");
        }
        return committed;
    }
    ...
    public boolean rollbackTransaction() {
        ...
        try {
            ...
            Log.exception(e, this, "rollbackTransaction");
        }
        return rolledBack;
    }
}