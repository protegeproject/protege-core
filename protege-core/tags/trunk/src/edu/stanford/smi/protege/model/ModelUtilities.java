...
public class ModelUtilities {
   ...
   public static Object getDirectOwnSlotValue(Frame frame, String name) {
       ...
       if (slot == null) {
           value = null;
           Log.warning("unknown slot", ModelUtilities.class, "getDirectOwnSlotValue", frame, name);
       } else {
   ...
   public static Collection getOwnSlotValues(Frame frame, String name) {
    ...
    public static List getDirectOwnSlotValues(Frame frame, String name) {
        ...
        if (slot == null) {
            values = Collections.EMPTY_LIST;
            Log.stack("unknown slot", ModelUtilities.class, "getDirectOwnSlotValues", frame, name);
        } else {
