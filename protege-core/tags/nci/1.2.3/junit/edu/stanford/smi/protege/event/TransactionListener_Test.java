...
public class TransactionListener_Test extends APITestCase {
    ...
    public void testTransactionBegin() {
        ...
        assertEventFired(TransactionEvent.TRANSACTION_BEGIN);  // only because transactions are not working...
    }
    ...
    public void testNestedTransactionsHidden() {
        for (DBType dbt : DBType.values()) {
            ...
            if (!dbConfigured()) {
              ...
              assert(getEventFired(TransactionEvent.TRANSACTION_BEGIN) == null);
