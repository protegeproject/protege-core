...
public abstract class FrameStore_Test extends SimpleTestCase {
    ...
    protected Cls createCls(Cls parent) {
        ...
        return _modifiableFrameStore.createCls(getID(), null, types, parents, true);
    }
    ...
    public void testGetOwnSlots() {
        ...
        assertEquals("sets", ownSlots, testOwnSlots);
    }
    ...
    public void testGetFrameName() {
        ...
        Cls cls = createCls();
        _modifiableFrameStore.setFrameName(cls, testName);
    ...
    public void testSetFrameName() {
        ...
        assertNull("before", _testFrameStore.getFrame(name));
        _testFrameStore.setFrameName(cls, name);
        assertEquals("new name", cls, _testFrameStore.getFrame(name));
        assertNull("oldName", _testFrameStore.getFrame(oldName));
    }
    ...
    public void testGetFramesWithOwnSlotValue() {
        ...
        assertEqualsSet(
            "values",
            makeList(instancea, instanceb),
            _testFrameStore.getFramesWithDirectOwnSlotValue(slot, "own"));
    }
    ...
    public void testGetFramesWithMatchingOwnSlotValue() {
        ...
        assertEqualsSet(
            "exact",
            makeList(instancea, instanceb),
            _testFrameStore.getFramesWithMatchingDirectOwnSlotValue(slot, "own", FrameStore.UNLIMITED_MATCHES));
        assertEqualsSet(
            "starts with",
            makeList(instancea, instanceb, instancec),
            _testFrameStore.getFramesWithMatchingDirectOwnSlotValue(slot, "OW*", FrameStore.UNLIMITED_MATCHES));
    }
