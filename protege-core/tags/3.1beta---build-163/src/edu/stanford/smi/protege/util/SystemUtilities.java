...
public class SystemUtilities {
    ...
    public static void setLookAndFeel(String lafName) {
        try {
            ...
            Log.warning("Look and feel not found: " + lafName, SystemUtilities.class, "loadLookAndFeel");
        } catch (Exception e) {
            Log.exception(e, SystemUtilities.class, "loadLookAndFeel");
        }
    }
    ...
    public static Object newInstance(Class clas, Class[] argumentClasses,
        ...
        try {
            ...
            Log.exception(e, SystemUtilities.class, "newInstance", clas,
                    argumentClasses, arguments);
        }
        return instance;
    }
    ...
    public static Object newInstance(String className) {
        ...
        try {
            ...
            if (clas == null) {
                Log.warning("no such class", SystemUtilities.class,
    ...
    public static void sleepMsec(int msecs) {
        try {
            ...
            Log.exception(e, SystemUtilities.class, "sleepMsec", new Integer(
                    msecs));
        }
    }
