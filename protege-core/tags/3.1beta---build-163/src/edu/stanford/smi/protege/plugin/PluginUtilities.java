...
public class PluginUtilities {
    ...
    public static Class forName(String className, boolean promiscuous) {
        ...
        try {
            ...
            Log.exception(e, PluginUtilities.class, "forName", className);
        }
        return clas;
    }
    ...
    private static boolean isLoadableClass(String className, ClassLoader loader, Class interfac) {
        ...
        try {
            ...
            if (clas != null) {
                ...
                if (!loadable) {
                    String text = className + " does not implement " + interfac;
                    Log.warning(text, PluginUtilities.class, "isLoadableClass");
                }
            }
        } catch (Throwable e) {
            Log.exception(e, PluginUtilities.class, "isLoadableClass");
        }
        return loadable;
    }
    ...
    private static boolean checkPlugin(ClassLoader loader, Attributes attributes, String className,
        ...
        if (isSet(attributes, attributeName)) {
            if (isLoadableClass(className, loader, pluginClass)) {
                ...
                if (o != null && o != loader) {
                    Log.error("Duplicate", PluginUtilities.class, "addPlugin", className);
                }
            }
        }
        return added;
    ...
    public static void findPluginsDirectory() {
        ...
        if (dir == null) {
            Log.warning("Application directory not specified", PluginUtilities.class,
                    "getPluginsDir");
        } else {
            ...
            if (file.exists()) {
                ...
                Log.warning("Plugins directory not found: " + file, PluginUtilities.class,
                        "getPluginsDir");
            }
        }
    }
    ...
    private static Manifest loadExtraManifest() {
        ...
        if (fileName != null) {
            try {
                ...
                Log.exception(e, PluginUtilities.class, "loadExtraManifest");
            }
        }
        return manifest;
    }
    ...
    private static void loadURL(String name, Properties properties, String property, int i,
        ...
        if (fileString != null) {
            ...
            if (url == null) {
                Log.error("missing file: " + fileString, PluginUtilities.class, "loadURL", name,
                        property);
            } else {
                map.put(name, url);
                // Log.trace("loaded: " + url, PluginUtilities.class, "loadURL",
                // name, property);
            }
        }
    }
    ...
    private static Properties getProperties(File dir) {
        ...
        if (file.exists()) {
            try {
                ...
                Log.exception(e, PluginUtilities.class, "getProperties", dir);
            }
        }
        return properties;
    }
    ...
    public static Collection getClassesWithAttribute(String key, String value) {
        ...
        while (i.hasNext()) {
            ...
            try {
                ...
                Log.exception(e, PluginUtilities.class, "getClassesWithAttribute", key, value);
            }
        }
        return classes;
    }
