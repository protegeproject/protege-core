...
public final class Parser implements ParserConstants {
    ...
    private Instance getInstance(String instanceName, Collection types) {
        ...
        if (instance == null) {
            ...
            if ((++nSetTypeInstances % INSTANCE_TRACE_COUNT_DELTA) == 0
                    && nSetTypeInstances >= MIN_INSTANCE_TRACE_COUNT) {
    ...
    final public String slotName() throws ParseException {
        ...
        if (s.equals("name_")) {
            ...
            if (s.equals(":domain-value") || s.equals(":range-value") || s.equals(":entry-slot")
                    || s.equals(":domain-value-slots") || s.equals(":range-value-slots")) {
    ...
    private static void jj_la1_0() {
        jj_la1_0 = new int[] { 0x0, 0x3a80000, 0x540000, 0xffff0000, 0x0, 0xffff0000, 0x0, 0xffff0000, 0x0, 0x800,
                0xffff0000, 0x10000, 0xffff0000, 0xffff0000, 0x23a80000, 0x200, 0xffff0000, 0xffff0000, 0xffff0000,
                0x6bfe0000, 0x8000, 0x0, 0xffff0000, 0x800, 0xffff0400, 0x8000, 0x800, 0x8000, 0x800, 0x0, 0x0, 0x0,
                0x8800, 0x0, 0xffff0000, 0xffff0000, 0xffff0000, 0x80000000, 0x0, 0xffff0000, 0x4000000, 0x0,
                0xffff0000, };
    }

    private static void jj_la1_1() {
        jj_la1_1 = new int[] { 0x18000100, 0x0, 0x0, 0xffffffff, 0x0, 0xffffffff, 0x0, 0xffffffff, 0x0, 0x0,
                0xffffffff, 0x1, 0xffffffff, 0xffffffff, 0x1000000, 0x14000000, 0xffffffff, 0xffffffff, 0xffffffff,
                0x1580806, 0x0, 0x0, 0xffffffff, 0x0, 0xffffffff, 0x0, 0x0, 0x0, 0x0, 0x2010000, 0x2010000, 0x8080,
                0x0, 0x40004000, 0xffffffff, 0xffffffff, 0xffffffff, 0x10, 0x80002000, 0xffffffff, 0x620, 0xa00000,
                0xffffffff, };
    }

    private static void jj_la1_2() {
        jj_la1_2 = new int[] { 0x0, 0x0, 0x0, 0x4fff, 0x2000, 0x4fff, 0x2000, 0x4fff, 0x2000, 0x0, 0x4fff, 0x0, 0x7fff,
                0x7fff, 0x40, 0x800, 0x7fff, 0x7fff, 0x7fff, 0x3d6, 0x0, 0x2000, 0x4fff, 0x0, 0x4fff, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x4fff, 0x7fff, 0x7fff, 0x0, 0x0, 0x4fff, 0x28, 0x0, 0xfff, };
    }
